 ...
 *
 * The storage key is v2-prefixed so devices still carrying the old app's
 * localStorage never auto-connect this build to anything.
 */

const SYNC_KEY_STORAGE = 'anchor:v2:sync-key';
